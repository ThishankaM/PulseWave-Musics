...
<div class="container-details">
    <h1>Super Impassioned Net Generation</h1><br>
...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/寄明月.jpg" alt="I want" class="cover">
      <div class="info">
        <h3>寄明月</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/爆竹声声贺新年.jpg" alt="Kantan Music" class="cover">
      <div class="info">
        <h3>爆竹声声贺新年</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/可叹.jpg" alt="Kashika" class="cover">
      <div class="info">
        <h3>可叹</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/山海图.jpg" alt="Peaky Peaky" class="cover">
      <div class="info">
        <h3>山海图</h3>
        <p>Single • 2024</p>
      </div>
