...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/iwant.jpg" alt="I want" class="cover">
      <div class="info">
        <h3>I want</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/KantanMusic.jpg" alt="Kantan Music" class="cover">
      <div class="info">
        <h3>Kantan Music</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/Kashika.jpg" alt="Kashika" class="cover">
      <div class="info">
        <h3>Kashika</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/PeakyPeaky.jpg" alt="Peaky Peaky" class="cover">
      <div class="info">
        <h3>Peaky Peaky</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/Heart111.jpg" alt="Heart 111" class="cover">
      <div class="info">
        <h3>Heart 111</h3>
        <p>Single • 2024</p>
      </div>
