    ...
    <style>
        body {
            background-image: 
                ...
                url('../Artist_art/CarlyRaeJepsen.jpg'); 
...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/callmemaybe.jpg" alt="I want" class="cover">
      <div class="info">
        <h3>Call Me Maybe</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/I_Really_Like_You.webp" alt="Kantan Music" class="cover">
      <div class="info">
