...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/usseewa.jpg" alt="Usseewa" class="cover">
      <div class="info">
        <h3>Usseewa</h3>
        <p>Single • 2020</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/giragira.jpg" alt="Gira Gira" class="cover">
      <div class="info">
        <h3>Gira Gira</h3>
        <p>Single • 2021</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/newgenesis.jpg" alt="New Genesis" class="cover">
      <div class="info">
        <h3>New Genesis</h3>
        <p>Single • 2022</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/odo.jpg" alt="Odo" class="cover">
      <div class="info">
        <h3>Odo</h3>
        <p>Single • 2021</p>
      </div>
