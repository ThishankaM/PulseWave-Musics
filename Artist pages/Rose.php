...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/apt.jpg" alt="I want" class="cover">
      <div class="info">
        <h3>APT</h3>
        <p>Rose & Bruno Mars • 2024</p>
      </div>
    </div>
    <div class="card">
      <img src="../album_art/Gone.jpg" alt="Kantan Music" class="cover">
      <div class="info">
        <h3>Gone</h3>
        <p>Single • 2024</p>
      </div>
