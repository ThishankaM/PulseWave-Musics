...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/Adamas.jpg" alt="I want" class="cover">
      <div class="info">
        <h3>ADAMAS</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/ReawakeR.jpg" alt="Kantan Music" class="cover">
      <div class="info">
        <h3>ReawakeR</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/Queen.jpg" alt="Kashika" class="cover">
      <div class="info">
        <h3>Queen</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/REALiZE.jpg" alt="Peaky Peaky" class="cover">
      <div class="info">
        <h3>REALiZE</h3>
        <p>Single • 2024</p>
      </div>
