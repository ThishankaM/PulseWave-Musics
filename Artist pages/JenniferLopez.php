...
<head>
    ...
    <style>
        body {
            background-image: 
                linear-gradient(to bottom, rgba(0, 0, 0, 0.1) 50%, black 100%), 
                url('../Artist_art/JenniferLopez.jpg'); 
...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/papi.jpg" alt="I want" class="cover">
      <div class="info">
        <h3>On The Floor</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art\papi.jpg" alt="Kantan Music" class="cover">
      <div class="info">
        <h3>Papi</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/followtheleader.jpg" alt="Kashika" class="cover">
      <div class="info">
    ...
    <div class="card">
      <img src="../album_art/aintyourmama.jpg" alt="Peaky Peaky" class="cover">
      <div class="info">
        <h3>Aint Your Mama</h3>
        <p>Single • 2024</p>
      </div>
    </div>
</div>
