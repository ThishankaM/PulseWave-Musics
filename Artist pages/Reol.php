...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/notitle.jpg" alt="No title" class="cover">
      <div class="info">
        <h3>No Title</h3>
        <p>Single</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/thesixthsense.jpg" alt="The Sixth Sense" class="cover">
      <div class="info">
    ...
    <div class="card">
      <img src="../album_art/shinobi.jpg" alt="SHINOBI" class="cover">
      <div class="info">
        <h3>SHINOBI</h3>
        <p>Single</p>
      </div>
