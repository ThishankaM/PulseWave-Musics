...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/sugar.jpg" alt="Sugar" class="cover">
      <div class="info">
        <h3>Sugar</h3>
        <p>Single • 2014</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/girl_like_you.jpg" alt="Girls Like You" class="cover">
      <div class="info">
    ...
    <div class="card">
      <img src="../album_art/memories.jpg" alt="Memories" class="cover">
      <div class="info">
        <h3>Memories</h3>
        <p>Single • 2019</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/sugar.jpg" alt="Maps" class="cover">
      <div class="info">
        <h3>Maps</h3>
        <p>Single • 2014</p>
      </div>
