...
<div class="music-grid">
    <div class="card">
      <img src="../album_art/Murderinmymind.jpg" alt="I want" class="cover">
      <div class="info">
        <h3>Murder In My Mind</h3>
        <p>Single • 2024</p>
      </div>
    </div>
    <div class="card">
      <img src="../album_art/KillersFronTheNorthside.jpg" alt="Kantan Music" class="cover">
      <div class="info">
        <h3>Killers From The Northside</h3>
        <p>Single • 2024</p>
      </div>
    </div>
    <div class="card">
      <img src="../album_art/Vyse.jpg" alt="Kashika" class="cover">
      <div class="info">
        <h3>Vyse</h3>
        <p>Single • 2024</p>
      </div>
    ...
    <div class="card">
      <img src="../album_art/MurderPlot.jpg" alt="Peaky Peaky" class="cover">
      <div class="info">
        <h3>MURDER PLOT</h3>
        <p>Single • 2024</p>
      </div>
